...
public class Client {
	...
	public static void main(String[] args) {
		// TODO: Implement the Context class with required methods and attributes (Hint: 2 attributes, 4 methods)
		// TODO: create the policy and the context inside the main method.
